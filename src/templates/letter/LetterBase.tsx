...
import { Calendar, Heart, Feather, FileText, User } from 'lucide-react';
...
export function LetterBase({ data, templateName }: LetterBaseProps) {
  ...
  const fontFamily = isTypewriter
    ...
    : theme?.fontFamily === 'serif' ? 'serif' : "'Inter', system-ui, sans-serif";
